...
def train_and_save_model(model, train_loader, test_loader, pgd_linf, lr_schedule=None, num_epochs=10, r_train=True, save_path="model.pt", project_name="compressed-robust"):
    ...
    opt = optim.SGD(model.parameters(), lr=3e-5)
    ...
    print({"test_loss": test_loss, "test_accuracy": test_err, "adv_accuracy": adv_err})
    ...
    print("begin to train_and_save_model")
    for t in range(num_epochs):
        ...
        print({"train_loss": train_loss, "train_accuracy": train_err, "test_loss": test_loss, "test_accuracy": test_err, "adv_accuracy": adv_err, "adv_loss":adv_loss})
